...
class LaporanController extends Controller
{
    ...
    public function pemesanan()
    {
        ...
        return view('admin.laporan.pemesanan.index', compact('pemesanan'));
    }

    public function pemesananDetail($id)
    {
        $p = DataPemesanan::with(['user', 'mobil', 'paket', 'pembayaran'])->findOrFail($id);
        return view('admin.laporan.pemesanan.detail', compact('p'));
    }
public function pemesananCetak(Request $request, $id = null)
    {
        ...
        if ($id) {
            ...
            $pdf = Pdf::loadView('admin.laporan.pemesanan.cetak', compact('p','tanggal_awal','tanggal_akhir'))
        ...
        $pdf = Pdf::loadView('admin.laporan.pemesanan.cetak', compact('pemesanan','tanggal_awal','tanggal_akhir'))
                  ->setPaper('a4','landscape');
    ...
    public function pembayaranDetail($id)
    {
        ...
        return view('admin.laporan.pembayaran.detail', compact('p'));
    }
...
public function pembayaranCetak(Request $request)
{
    ...
    // Generate PDF
    $pdf = Pdf::loadView('admin.laporan.pembayaran.cetak', [
