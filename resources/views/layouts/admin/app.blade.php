...
<body>
    ...
    <nav class="navbar navbar-dark px-3 d-flex justify-content-between">
        <span class="navbar-text text-white fw-bold">
            SELAMAT DATANG ADMIN | RENTAL MOBIL PUSKOPKA JATENG
        </span>
        {{-- Ikon Profil --}}
            ...
            <ul class="nav flex-column mt-3">
                ...
                <li>
                    <a href="{{ route('datauser.index') }}" class="nav-link">
                        <img src="{{ asset('gambar/f7_person-alt.png') }}" alt="Akun Pengguna"> Akun Pengguna
                    </a>
                </li>
                <li>
                    <a href="{{ route('mobill.index') }}" class="nav-link">
                        <img src="{{ asset('gambar/bxs_car.png') }}" alt="Mobil"> Mobil
                    </a>
                </li>
                <li>
                    <a href="{{ route('paket.index') }}" class="nav-link">
                        <img src="{{ asset('gambar/Vector.png') }}" alt="Paket"> Paket
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.pemesanan.index') }}" class="nav-link">
                        <img src="{{ asset('gambar/lsicon_order-filled.png') }}" alt="Pemesanan"> Pemesanan
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.pembayaran.index') }}" class="nav-link">
                        <img src="{{ asset('gambar/uang.png') }}" alt="Pembayaran"> Pembayaran
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.review.index') }}" class="nav-link">
                        <img src="{{ asset('gambar/dashicons_testimonial.png') }}" alt="Testimoni"> Testimoni
                    </a>
                </li>
                <li>
                    ...
                    <div class="collapse ps-4" id="laporanMenu">
                        <a href="{{ route('admin.laporan.pemesanan') }}" class="nav-link">Laporan Pemesanan</a>
                        <a href="{{ route('admin.laporan.pembayaran') }}" class="nav-link">Laporan Pembayaran</a>
                    </div>
                </li>
                <li>
